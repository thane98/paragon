class AddSpawnAction:
    ...
    def undo(self):
        ...
        self.controller.view.status_bar.showMessage("Deleted spawn " + self.spawn.get_display_name())
    ...
    def redo(self):
        ...
        self.controller.view.status_bar.showMessage("Added spawn " + self.spawn.get_display_name())
