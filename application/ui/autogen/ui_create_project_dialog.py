...
class Ui_CreateProject(object):
    ...
    def retranslateUi(self, CreateProject):
        ...
        self.language_box.setItemText(3, QtWidgets.QApplication.translate("CreateProject", "French", None, -1))
        self.language_box.setItemText(4, QtWidgets.QApplication.translate("CreateProject", "Spanish", None, -1))
