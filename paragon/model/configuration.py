...
class Configuration(BaseModel):
    ...
    fe9_job_icons: Dict[str, int] = pydantic.Field(
        default_factory=default_fe9_job_icons
    )
    fe10_job_icons: Dict[str, int] = pydantic.Field(
        default_factory=default_fe10_job_icons
    )
