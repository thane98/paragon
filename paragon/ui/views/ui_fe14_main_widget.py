...
from PySide6.QtWidgets import QWidget, QPushButton, QGroupBox, QVBoxLayout, QGridLayout
...
class Ui_FE14MainWidget(QWidget):
    def __init__(self):
        ...
        self.butler_voice_button = QPushButton("Butler Voices")
        ...
        self.castle_position_button = QPushButton("Position Data")
        self.dining_data_title_button = QPushButton("Dining Data (Title)")
        self.dining_data_cooking_button = QPushButton("Dining Data (Cooking)")
        ...
        my_castle_layout.addWidget(self.butler_voice_button)
        my_castle_layout.addWidget(self.arena_combatants_low_button)
        my_castle_layout.addWidget(self.arena_combatants_high_button)
        my_castle_layout.addWidget(self.castle_position_button)
        my_castle_layout.addWidget(self.dining_data_title_button)
        my_castle_layout.addWidget(self.dining_data_cooking_button)
        my_castle_box.setLayout(my_castle_layout)

        self.field_button = QPushButton("Map Field / 3D Models")
        self.animation_sets_button = QPushButton("Animation Sets")
        ...
        assets_layout.addWidget(self.animation_sets_button)
